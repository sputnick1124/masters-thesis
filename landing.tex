...
Let $R\left(\phi, \theta, \psi\right)$ be the orthogonal matrix defined as
\begin{equation}
    R(\phi,\theta,\psi) = 
    \begin{bmatrix}
...
Ultimately, these limitations proved too large an obstacle to be overcome within the scope of the project and
...
\begin{figure}[ht]
    \begin{subfigmatrix}{3}
        \subfigure[Fuzzy input partition \label{f:error_in_mfs}]{\includegraphics{images/error_in.png}}
        \subfigure[Fuzzy input partition \label{f:error_d_in_mfs}]{\includegraphics{images/error_del_in.png}}
        \subfigure[Fuzzy output partition \label{f:vel_out_mfs}]{\includegraphics{images/vel_out.png}}
    \end{subfigmatrix}
