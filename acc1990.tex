...
membership functions\label{f:x2mfs}]{\includegraphics{images/x2_mfs.pdf}} \subfigure[$\dot{x}_2$ membership
functions\label{f:x4mfs}]{\includegraphics{images/x4_mfs.pdf}} \end{subfigmatrix} \caption{Input membership
...
generation.\label{f:popfitness}]{\includegraphics{images/popFitness.pdf}} \subfigure[Individual fitness average by
generation.\label{f:popaverage}]{\includegraphics{images/popAverage.pdf}} \end{subfigmatrix} \end{figure}
